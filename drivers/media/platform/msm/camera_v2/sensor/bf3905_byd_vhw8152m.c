...
static struct msm_camera_i2c_reg_conf bf3905_recommend_settings[] = {
	...
	{0xc8,0x0d},//0d 12.03
	{0xc9,0x19},//10 12.03
	{0xd0,0x93},//69 11.29//39
	{0xd1,0xab},//00 11.29//1204
	{0xd2,0x58},
	{0xd3,0x0c},//09 11.29
	{0xd4,0x30},//24 11.29
	{0xee,0x30},
	...
	{0x6e,0x20},
	{0xbc,0x0d},
	{0x35,0x8f}, //0x82   0x8f 92  //7f 11.29
	{0x65,0x78}, //84   // 7f  0929
	{0x66,0x7d}, //80  //7a  0929
	{0xbd,0xfa}, //0xe8//0xec  11.29
	{0xbe,0x49}, 
	{0x9b,0xf3},//0xe4  11.29
	{0x9c,0x4c},
	{0x37,0xf4},//0xe4  11.29
	{0x38,0x50}, 
	{0x70,0x0b},
	{0x71,0x0f},// 0e  yzx 4.17   0x3f  wl 5.3
	{0x72,0x4c},//4c 11.29//1c
	{0x73,0x28},
	{0x74,0x6d},//6d 11.29//2d
	{0x75,0xaa},  //8a yzx  4.17
	{0x76,0x28}, //  98  yzx  4.17
	{0x77,0x2a},//2a 0929//6a 11.29
	{0x78,0xff},
	{0x79,0x24},
	...
	{0x9f,0x64},
	{0x39,0xa0}, //98  yzx 4.17//90 0927  11.29
	{0x3f,0x20}, //98  yzx 4.17//90 0927
	{0x90,0x20},//20 0927
	{0x91,0x70},//70 0927
	...
	*/
	...
	{0xa1,0x31},
	{0xa2,0x0d},
	{0xa3,0x2a},//0x27 11.29
	{0xa4,0x0a},
	{0xa5,0x28},//0x27 11.29
	{0xa6,0x04},
	{0xa7,0x1a},
	{0xa8,0x15}, //16  15
	{0xa9,0x12},
...
/****************************************************************************
* FunctionName: bf3905_add_project_name;
* Description : add the project name and app_info display;
***************************************************************************/
static int bf3905_add_project_name(struct msm_sensor_ctrl_t *s_ctrl)
{
    ...
    strncpy(s_ctrl->sensordata->sensor_info->sensor_project_name, "23060075FF-BYD-B", strlen("23060075FF-BYD-B")+1);

    pr_info("%s %d : bf3905_add_project_name sensor_project_name=%s \n",  __func__, __LINE__,
            s_ctrl->sensordata->sensor_info->sensor_project_name);
    
    /*add the app_info*/
    app_info_set("camera_slave", "bf3905_byd");

    pr_info("bf3905_add_project_name OK\n");
    return 0;
}
...
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
    .sensor_add_project_name = bf3905_add_project_name,
#endif
};
